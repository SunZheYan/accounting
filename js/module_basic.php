        ...
        <div class="container-fluid">\
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">\
                <ul class="navbar-nav me-auto">\
                    <li class="nav-item mb-6"><a href="read2.php" class="nav-link">上傳</a>\
                    </li>\
                </ul>\
                <ul class="navbar-nav me-auto">\
                    <li class="nav-item mb-6"><a href="Completion-date.php" class="nav-link">上傳2</a>\
                    </li>\
                </ul>\
                <span class="d-flex">\
    ...
    if (loggedin) {
        for (let loop of document.querySelectorAll('.ilogin')) {
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">\
                ...
                <li><a class="dropdown-item" href="select.php">搜尋</a></li>\
            </ul>';
        }
    }
}
