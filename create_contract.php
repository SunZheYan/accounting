...
<body>
    ...
    <form method="post" action="_create_contract.php">
        ...
        <input readonly="readonly" style="outline: none;border: 0;" required class="col-md-10" id="housename" name="type" value="<?php echo $data['title']; ?>">
    ...
    <section class="container">
        ...
        <div class="row">
            ...
            <input readonly="readonly" required class="col-md-10" name="landlord" type="hidden" placeholder="如馬一九" value="<?php echo $userdata['name']; ?>">
        </div><br>
    </section>
    <section class="container">
